...
$('#add').click(function() {
    ...
    var year_published = $("input#year_published").val();
...
$('button#update_cancel').click(function() {
    ...
    $('#form-update').find('#year_published').val();
    $('#form-update').find('#publisher').val();
    $('#form-update').find('#ISBN').val();
...
$('button#update_done').click(function() {
    ...
    var bisbn = $('#form-update').find('#ISBN').val();
    var bpublisher = $('#form-update').find('#publisher').val();
    var byear_published = $('#form-update').find('#year_published').val();
    ...
    if (stockqty != '' && bname != '' && bauthor != '' && bcategory != '') {
        $.ajax({
            ...
            data: {
                ...
                'stock_qty': stockqty,
                'ISBN': bisbn,
                'year_published': byear_published,
            ...
            success: function(data) { 
                    ...
                    $(row_id+ ' td:eq(1)').html(bisbn);
                    $(row_id+ ' td:eq(2)').html(bname);
                    $(row_id+ ' td:eq(3)').html(bauthor);
                    $(row_id+ ' td:eq(4)').html(data[0].name);
                    $(row_id+ ' td:eq(5)').html(byear_published);
                    $(row_id+ ' td:eq(6)').html(bpublisher);      
                    $(row_id+ ' td:eq(7)').html(data[0].stock_qty-data[0].borrow_qty+' out of '+data[0].stock_qty);       
...
$(document).on("click", "button.delete_announcement", function() {
    $('tr').removeClass('deletable');
  $(this).parents("tr").addClass('deletable');
...
$(document).on("click", "button.delete_reserve", function() {
    $('tr').removeClass('deletable');
  $(this).parents("tr").addClass('deletable');
  var id =  $(this).parents("tr").find('input#id').val();
          $('button.yesDel').click(function() {
...
$('.add-Member').click(function() {
    ...
    var user_id = $('form#Registration-Form').find('input[name=user_id]').val();
